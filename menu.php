...
<nav class="" style="font-size: 20px;display: flex;justify-content: center;margin-bottom:1%;margin-top:1%;">
 ...
 -->
 	...
 	<ul class="nav nav-pills nav-user center-block">
		...
		<li role="presentation" class="">
			<a href="profile-user.php"><span class="glyphicon glyphicon-user" aria-hidden="true"></span> 
			<b>PROFILE</b>
			</a>
		</li>
<?php if( $_SESSION['acctype']=='3') { ?>
		<li>
			<a href="classroom.php"><span class="glyphicon glyphicon-book" aria-hidden="true"></span> 
			<b>CLASSROOM</b>
			</a>
		</li>
<?php } ?>
		<li>
			...
			<b>LOGOUT</b>
				...
				<!-- <li role="presentation" class="">
			<a href="classroom.php"><span class="glyphicon glyphicon-user" aria-hidden="true"></span> 
			<b>CLASSROOM</b>
			</a>
		</li> -->
	</ul>
